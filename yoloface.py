...
# print('[i] The model-model-weights of model file: ', args.model_weights)
# print('[i] Path to image file: ', args.image)
# print('[i] Path to video file: ', args.video)
# print('###########################################################\n')

FULL_CFG_PATH = "./cfg/yolov3-spp.cfg"
FULL_WEIGHTS_PATH = "./model-model-model-weights/yolov3-spp.model-model-weights"
...
def load_args_and_model():
    ...
    parser.add_argument('--model-model-model-weights', type=str,
                        default='./model-model-model-weights/yolov3-wider_16000.model-model-weights',
                        help='path to model-model-weights of model')
